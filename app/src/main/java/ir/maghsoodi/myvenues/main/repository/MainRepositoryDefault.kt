...
class MainRepositoryDefault @Inject constructor(
    ...
    override suspend fun getNearVenues(lat: Double, lng: Double) {
    ...
    private suspend fun saveToDB(ratesResponse: Resource<SearchResponse>) {
